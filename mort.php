...
if (isset($_POST["submit"])){
  ...
  global $link;
  $editing = $_GET['Edit'];
  $req = "UPDATE bovins set datemort='$dv',mort='$v'where id_bov='$editing' ";
...
?>
    <form class="" action="mort.php?Edit=<?php echo $searching ; ?>" method="post">
      <fieldset>

        <div class="form-group col-md-6">
          <label for="type">Date de mort:</label>
          <input required  type="date" class="form-control" name="datemort" value="">
        </div>
