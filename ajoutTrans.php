...
if (isset($_POST["submit"])){
  ...
  $tel = $_POST["tel"];
  global $link;
  $req = "INSERT INTO tansporteur(cin_t,nom,prenom,tel)VALUES('$cin','$nom','$prenom','$tel')";
        ...
        <div class="col-sm-10">
          ...
          <div class="">
            <div class="panel panel-primary">
              <div class="panel-heading">Ajouter un Transporteur</div>
  <div class="panel-body">
    <form class="" action="ajoutTrans.php" method="post">
      <fieldset>

        <div class="form-group col-md-6">
          <label for="type">Cin:</label>
          <input required  type="text" class="form-control" name="cin" value="">
        </div>
        <div class="form-group col-md-6">
        ...
        <input required  class="btn btn-primary btn-block" type="submit" name="submit" value="Ajouter">
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">Les Transporteur Availables</div>
<div class="panel-body">
  ...
  <?php
            ...
            while ($datarows=mysqli_fetch_array($exec)) {
              ...
              <td><?php echo $tel; ?></td>
              <td>
              <a href="AfficheVeh.php?Id=<?php echo $Id; ?>"><span class="btn btn-success">Vehicules &nbsp;&nbsp;</span></a>
