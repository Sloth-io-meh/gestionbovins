...
if (isset($_POST["submit"])){
  ...
  $tel=$_POST["tel"];
  global $link;
  $req = "INSERT INTO veto(id_vet,nom_vet,prenom_vet,tel_vet)VALUES('$Id','$nom','$prenom','$tel')";
        ...
        <div class="col-sm-10">
          ...
          <div class="">
            <div class="panel panel-primary">
              <div class="panel-heading">Ajouter un Veterinaire</div>
  <div class="panel-body">
    <form class="" action="ajoutVeto.php" method="post">
      <fieldset>
