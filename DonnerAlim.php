...
if (isset($_POST["submit"])){
  ...
  $ids = $_POST["ids"];
  global $link;
  $req = "INSERT into nourriture(libelle_n,quantite_n,id_bov) VALUES ('$lib','$qte','$idb') ";

  $exec = mysqli_query($link, $req);

  if ($exec) {
      $req1 = "UPDATE stock set quantiteAct=quantiteAct-'$qte' where id_stock='$ids'";
        ...
        <div class="col-sm-10">
          ...
          <div class="">
            <div class="panel panel-primary">
              <div class="panel-heading">Donner l'Alimentation</div>
...
?>
    <form class="" action="DonnerAlim.php?Edit=<?php echo $searching; ?>" method="post">
      <fieldset>
