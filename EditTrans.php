...
if (isset($_POST["submit"])){
  ...
  global $link;
  $editing = $_GET['Edit'];
  $req = "UPDATE tansporteur set cin_t='$cin',nom='$nomA',prenom='$prenom',tel='$tel' where id_trans='$editing' ";
        ...
        <div class="col-sm-10">
          ...
          <div class="">
            <div class="panel panel-primary">
              <div class="panel-heading">Modifier un etable</div>
  <div class="panel-body">
    <?php
$searching= $_GET['Edit'];
global $link;
$req="Select * From tansporteur where id_trans ='$searching' ";
$exec=mysqli_query($link, $req);
while ($datarows = mysqli_fetch_array($exec)) {
$cinup =$datarows['cin_t'];
$nomupdate =$datarows['nom'];
$prenomupdate =$datarows['prenom'];
$telnomupdate =$datarows['tel'];
}
?>
    <form class="" action="EditTrans.php?Edit=<?php echo $searching ; ?>" method="post">
    <fieldset>

<div class="form-group col-md-6">
  <label for="type">Cin:</label>
  <input required  type="text" class="form-control" name="cin" value=" <?php echo $cinup;  ?> ">
</div>
<div class="form-group col-md-6">
...
<div class="form-group col-md-6">
  ...
  <input required  type="text" class="form-control" name="tel" value="<?php echo $telnomupdate;  ?>">
</div>
...
<div class="table-responsive">
  ...
  <?php
            global $link;
            $view = "SELECT * FROM tansporteur";
            $exec=mysqli_query($link,$view);
            $sr = 0;
            while ($datarows=mysqli_fetch_array($exec)) {
              $Id = $datarows["id_trans"];
              $cin=$datarows["cin_t"];
              $nom=$datarows["nom"];
              ...
              <td><?php echo $tel; ?></td>
              <td>
              <a href="AfficheVeh.php?Edit=<?php echo $Id; ?>"><span class="btn btn-success">Vehicules &nbsp;&nbsp;</span></a>
              <a href="EditTrans.php?Edit=<?php echo $Id; ?>"><span class="btn btn-warning">modifier &nbsp;&nbsp;</span></a>
               <a href="DeleteTrans.php?id=<?php echo $Id; ?>"> <span class="btn btn-danger">supprimer</span></a></td>
              </tr>
 <?php } ?>
  </table>
</div>
