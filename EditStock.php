...
if (isset($_POST["submit"])){
  ...
  global $link;
  $editing = $_GET['Edit'];
  $req = "UPDATE stock set libelle_st='$nom',description_s='$desc',quantite_s='$q',quantiteAct='$q',prix_s='$p',dateachat='$dateA',dateexp_s='$dateX'where id_stock='$editing' ";
...
$searching= $_GET['Edit'];
global $link;
$req="Select * From Stock where id_stock ='$searching' ";
$exec=mysqli_query($link, $req);
...
?>
    <form class="" action="EditStock.php?Edit=<?php echo $searching ; ?>" method="post">
      <fieldset>
