...
if (isset($_POST["submit"])){
  ...
  $dateX = $_POST["dateX"];
  global $link;
  $req = "INSERT INTO meds(libelle,description,quantite_med,prix_med,dateachat,dateexp_med)VALUES('$nom','$desc','$q','$p','$dateA','$dateX')";
        ...
        <div class="col-sm-10">
          ...
          <div class="">
            <div class="panel panel-primary">
              <div class="panel-heading">Ajouter un medicament</div>
  <div class="panel-body">
    <form class="" action="ajoutMed.php" method="post">
      <fieldset>
